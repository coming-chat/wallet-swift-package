// Objective-C API for talking to go-defi-sdk/core/crossswap/types Go package.
//   gobind -lang=objc go-defi-sdk/core/crossswap/types
//
...
- (nonnull instancetype)initWithRef:(_Nonnull id)ref;
- (nonnull instancetype)init;
// skipped field AllToken.Tokens with unsupported type: []go-defi-sdk/core/crossswap/types.TokenInfo

// skipped field AllToken.Chains with unsupported type: []go-defi-sdk/core/crossswap/types.ChainInfo
...
// skipped field ChainInfo.Tokens with unsupported type: []go-defi-sdk/core/crossswap/types.TokenInfo
...
- (nonnull instancetype)initWithRef:(_Nonnull id)ref;
- (nonnull instancetype)init;
// skipped field ChainListRes.Chains with unsupported type: []go-defi-sdk/core/crossswap/types.ChainInfo
...
// skipped field Connection.ToTokens with unsupported type: []go-defi-sdk/core/crossswap/types.TokenInfo
...
- (nonnull instancetype)initWithRef:(_Nonnull id)ref;
- (nonnull instancetype)init;
// skipped field ConnectionsRes.Connections with unsupported type: []go-defi-sdk/core/crossswap/types.Connection
...
- (nonnull instancetype)initWithRef:(_Nonnull id)ref;
- (nonnull instancetype)init;
// skipped field Connectionv3Res.AllToken with unsupported type: go-defi-sdk/core/crossswap/types.AllToken

// skipped field Connectionv3Res.Chains with unsupported type: []go-defi-sdk/core/crossswap/types.ChainInfo
...
// skipped field Estimate.Costs with unsupported type: []go-defi-sdk/core/crossswap/types.Cost
...
- (nonnull instancetype)initWithRef:(_Nonnull id)ref;
- (nonnull instancetype)init;
// skipped field GetChainTokensRes.Chains with unsupported type: []go-defi-sdk/core/crossswap/types.ChainInfo
...
- (nonnull instancetype)init;
@property (nonatomic) long totalPage;
// skipped field SearchTokenRes.Tokens with unsupported type: []go-defi-sdk/core/crossswap/types.TokenInfo
...
- (nonnull instancetype)init;
@property (nonatomic) NSString* _Nonnull chainType;
// skipped field TokenListRes.Tokens with unsupported type: []go-defi-sdk/core/crossswap/types.TokenInfo

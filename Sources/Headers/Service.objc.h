// Objective-C API for talking to go-defi-sdk/core/crossswap/service Go package.
//   gobind -lang=objc go-defi-sdk/core/crossswap/service
//
 ...
 */
- (TypesConnectionsRes* _Nullable)getConnections:(NSString* _Nullable)fromChain fromToken:(NSString* _Nullable)fromToken toChain:(NSString* _Nullable)toChain error:(NSError* _Nullable* _Nullable)error;
/**
...
/**
 * GetStatus query status by fromChain & txHash
 */
